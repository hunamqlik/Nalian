...
cmd({
    ...
    try {
        ...
        const url = `https://i.ibb.co/YBgqsR7b/lordali.jpg}`;
        ...
        // Image AI à envoyer
        const ALIVE_IMG = 'https://i.ibb.co/YBgqsR7b/lordali.jpg'; // Remplacez par l'URL de votre image AI
